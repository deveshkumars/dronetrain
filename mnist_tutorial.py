import jax
print(jax.__version__, "should be at least0.4.20")
...
# Run the model with LiteRT (TFLite)
...
jax_mnist_filename = "jax_mnist.tflite"

files.download(jax_mnist_filename)

jax_mnist_quant_filename = "jax_mnist_quant.tflite"

files.download(jax_mnist_quant_filename)